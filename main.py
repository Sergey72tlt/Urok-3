...
for i in my_list:
    if i > 0:
        a = math.sqrt(i)
        print('число:{}, корень числа:{}'.format(i, a))
        if a // 1 == a:
            print(a, '//')
        if a % 1 == a:
            print(a, '%')
...
def list_rnd(n):
    result_lst = []
    for i in range(n):
        result_lst.append(randint(-100, 100))
    return result_lst

n = int(input('Введите нужное количество: '))
